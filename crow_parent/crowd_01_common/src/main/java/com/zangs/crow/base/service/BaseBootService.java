...
import com.zangs.crow.base.entity.DataBaseEntity;
import com.zangs.crow.base.entity.Pager;
import com.zangs.crow.base.entity.PageredData;
import org.nutz.dao.*;
 ...
 */
public class BaseBootService<T extends DataBaseEntity> extends IdNameEntityService<T> {
    ...
    public Pager<T> searchByKeyAndPage(String key, int page, int pageSize, Cnd cnd, String... fields) {
        ...
        for (String field : fields) {
            if (index == 0) {
                expressionGroup.and(Cnd.exp(field, "like", String.format("%%%s", key)));
            } else {
                expressionGroup.or(Cnd.exp(field, "like", String.format("%%%s", key)));
            }
            index++;
        }
