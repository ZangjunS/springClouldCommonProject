...
public class VCodeUtils {
    ...
    public static void main(String[] args) {
        ...
        try {
            VCodeUtils vc = new VCodeUtils(7);
            saveImage(vc.getImage(), new FileOutputStream("D:/a.jpg"));
            System.out.println(vc.getText());


            saveImage(vc.getImage(), new FileOutputStream("D:/b.jpg"));
            System.out.println(vc.getText());


            saveImage(vc.getImage(), new FileOutputStream("D:/c.jpg"));
            System.out.println(vc.getText());
        } catch (Exception e) {
